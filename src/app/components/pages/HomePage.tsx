...
export const HomePage = () => {
  return (
    <div className="w-full h-full">
      {/* Hero section */}
      <div className="w-full h-[500px] bg-[url(/bgimage.webp)] bg-cover flex items-center px-10 opacity-105">
        <div className="card card-dash bg-base-100 w-1/3 h-2/3 ">
      ...
      {/* Divider */}
      <div className="w-full h-60 bg-secondary flex flex-row text-warning-content my-10">
